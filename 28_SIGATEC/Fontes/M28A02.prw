...
Static Function MenuDef()
    ...
    aAdd(aRotina, {'Visualizar', 'VIEWDEF.M28A02',0,2})
    aAdd(aRotina, {'Incluir',    'VIEWDEF.M28A02',0,3})
    aAdd(aRotina, {'Alterar',    'VIEWDEF.M28A02',0,4})
    aAdd(aRotina, {'Excluir',    'VIEWDEF.M28A02',0,5})
Return aRotina
