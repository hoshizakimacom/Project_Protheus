...
±±³Descri‡…o ³ Relatório Gerencial de Vendas - Remessa Peças Faltantes    ³±±
...
oReport := TReport():New("M28R01","Vendas Gerencial - Remessa Peças Faltantes","M28R01", {|oReport| ReportPrint(oReport,cAliasQry,oVenProd)},"Este relatorio emite a relacao gerencial de itens do pedido de venda." + "Serão itens do pedido com operação igual a " + "32")
...
//³                                                                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oVenProd := TRSection():New(oReport,"GERENCIAL VENDAS - REMESSA PEÇAS FALTANTES",{"SC6","SB1"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)		// "Relacao de Pedidos por Produto"
