...
//+------------------------------------------------------------------------------------------------
//  Função chamada de gatilhos na SB1
//+------------------------------------------------------------------------------------------------
User Function M05G03(_cField)
    ...
    Case _cField $ 'B1_POSIPI|B1_EX_NCM'
        ...
        MG04GetGrp()    // Inclui grupo de tribuação
...
//+------------------------------------------------------------------------------------------------
//| Preenche conta contábil de acordo com o grupo e tipo informados no cadstro do produto
//+------------------------------------------------------------------------------------------------
...
//+------------------------------------------------------------------------------------------------
//| Preenche grupo de tributação do produto
//+------------------------------------------------------------------------------------------------
...
Static Function MG04GetIPI()
    Private _cPosIPI  := FwFldGet("B1_POSIPI")
    Private _nIPI     := 0
...
Static Function MG04GetCta()
    ...
    Case _cTipo == 'MI'         // Material intermediário
        _cConta := '1140100002'
...
Static Function MG04GetCc()
    ...
    Do Case
        ...
        Case FwFldGet("B1_XFAMILI") == '000002'    // Cocção
            If _cTipo $ "BN|MI" 
                _cCc    := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_CC")  
                _cLocal := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_LOCPAD")
            Endif

        Case FwFldGet("B1_XFAMILI") == '000003'    // Mobiliário Aço
            If _cTipo $ "BN|MI" 
                _cCc    := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_CC")  
                _cLocal := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_LOCPAD")
            Endif

        Case FwFldGet("B1_XFAMILI") == '000004'    // Máquina de Gelo - Componentes
            If _cTipo $ "BN|MI" 
                _cCc    := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_CC")  
                _cLocal := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_LOCPAD")
            Endif
        ...
        Case FwFldGet("B1_XFAMILI") == '000006'    // Revenda não Hoshizaki
            If _cTipo $ "MI|ME" 
                _cCc    := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_CC")  
                _cLocal := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_LOCPAD")
            Endif

        Case FwFldGet("B1_XFAMILI") == '000007'    // Matéria Prima
            If _cTipo $ "MP" 
                _cCc    := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_CC")  
                _cLocal := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_LOCPAD")
            Endif
        
        Case FwFldGet("B1_XFAMILI") == '000008'    // Peças de Reposição - Suporte Tec.
            If _cTipo $ "ME" 
                _cCc    := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_CC")  
                _cLocal := Posicione("ZA1",1,xFilial("ZA1")+FwFldGet("B1_XFAMILI"),"ZA1_LOCPAD")
            Endif
