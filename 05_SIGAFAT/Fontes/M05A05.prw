...
//+---------------------------------------------------------------------------------
//	Responsável pelo preenchimento dos campos customizados do orçamento de vendas
...
cTeste := '2' 
	...
	// Efetua liberação financeira para o cliente Arcos Dourados.
//	M->C5_XSTSFIN  := IIF(SCJ->CJ_CLIENTE == '002953' .Or. SCJ->CJ_CLIENTE == '000001','2','1')
	...
	M->C5_ACRSFIN  := Posicione('SE4',1, xFilial('SE4') + SCJ->CJ_CONDPAG,'E4_ACRSFIN') // Solução alternativa até a Totvs enviar correção - Não está carregando o acrescimo financeiro para o pedido de venda
Return
