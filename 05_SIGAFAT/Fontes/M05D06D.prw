...
//+-------------------------------------------------------------------------------------------------
//  Rotina de Exclusão de clientes a partir de arquivo CSV
//+-------------------------------------------------------------------------------------------------
...
Static Function MD05Log(_cArqLog,_cMsg,_cLog,_nErr,_nInc)
    ...
    _cLog := CRLF + CRLF + I18N('Clientes Excluídos: #1',{_nInc})  +  CRLF + I18N('Clientes não excluídos (erro): #1',{_nErr}) + CRLF + CRLF + _cLog
...
Static Function MD05Put(aReg,_cMsgLog,_nErr,_nInc)
    ...
    BeginTran()
        ...
        MSExecAuto({|x,y| Mata030(x,y)},aReg,5)
