...
TRCell():New(oPedVC,"CREGIAO"	,		,"Regiao"				,PesqPict("SX5","X5_DESCRI") ,TamSx3("X5_DESCRI")[1]-40 ,/*lPixel*/,{|| cReg }					)	// Região do Cliente
...
TRCell():New(oPedVC,"EMISSAO"	,		,RetTitle("C5_EMISSAO") ,PesqPict("SC5","C5_EMISSAO"),TamSx3("C5_EMISSAO"	)[1],/*lPixel*/,{|| dEmissao	}				)	// Data de Emissão do Pedido de Venda
