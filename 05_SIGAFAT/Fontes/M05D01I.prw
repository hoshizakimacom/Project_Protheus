...
_CARQORI := CGETFILE("CSV | *.CSV","SELECIONE ARQUIVO DE TITULOS A RECEBER",,"", .T. ,0+48+8)
RETURN 
...
_CLOG := CHR(13)+CHR(10) + CRLF+I18N("TITULOS INCLUÍDOS: #1",{_NINC}) + CRLF+I18N("TÍTULOS NÃO INCLUÍDOS (ERRO): #1",{_NERR}) + CRLF + CRLF+_CLOG
