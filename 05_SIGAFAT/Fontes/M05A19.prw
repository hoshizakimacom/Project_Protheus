...
Static Function MenuDef()
    ...
    aAdd(aRotina, {'Visualizar',     'VIEWDEF.M05A19',0,2})
    aAdd(aRotina, {'Incluir',        'VIEWDEF.M05A19',0,3})
    aAdd(aRotina, {'Alterar',        'VIEWDEF.M05A19',0,4})
    aAdd(aRotina, {'Excluir',        'VIEWDEF.M05A19',0,5})
Return aRotina
...
Static Function ModelDef()
    ...
    oModel:GetModel( 'ZA7MASTER' ):SetDescription( 'Dados do Grupo Econômico' )
