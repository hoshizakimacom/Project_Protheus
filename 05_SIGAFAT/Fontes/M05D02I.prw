...
_CARQORI := CGETFILE("CSV | *.CSV","SELECIONE ARQUIVO DE VENDEDORES",,"", .T. ,0+48+8)
RETURN 
...
_CLOG := CHR(13)+CHR(10) + CRLF+I18N("VENDEDORES INCLUÍDOS: #1",{_NINC}) + CRLF+I18N("VENDEDORES NÃO INCLUÍDOS (ERRO): #1",{_NERR}) + CRLF + CRLF+_CLOG
