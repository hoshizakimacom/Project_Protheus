...
User Function M05A16()
    ...
    _oBrowse:SetDescription('Descrição Finame')
...
//    ADD OPTION aRotina TITLE 'Excluir'    ACTION 'VIEWDEF.M05A16' OPERATION 5 ACCESS 0
        ...
        AAdd(aRotina,{"Visualizar" , "VIEWDEF.M05A16"    , 0, 2 } )
      AAdd(aRotina,{"Incluir" , "VIEWDEF.M05A16"    , 0, 3 } )
       AAdd(aRotina,{"Alterar" , "VIEWDEF.M05A16"    , 0, 4 } )
        AAdd(aRotina,{"Excluir" , "VIEWDEF.M05A16"    , 0, 5 } )
Return aRotina
...
Static Function ModelDef()
    ...
    oModel:SetDescription( 'Descrição Finame' )

    oModel:GetModel( 'ZA4MASTER' ):SetDescription( 'Dados da Descrição Finame' )
