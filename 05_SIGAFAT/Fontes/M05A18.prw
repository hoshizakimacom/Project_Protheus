...
Static Function MenuDef()
    ...
    aAdd(aRotina, {'Visualizar','VIEWDEF.M05A18',0,2})
    aAdd(aRotina, {'Incluir',   'VIEWDEF.M05A18',0,3})
    aAdd(aRotina, {'Alterar',   'VIEWDEF.M05A18',0,4})
    aAdd(aRotina, {'Excluir',   'VIEWDEF.M05A18',0,5})
Return aRotina
