...
LOCAL _ODLG := NIL
LOCAL _CTITLE := "ATUALIZAÇÃO DE CLIENTES"
LOCAL _OARQORI := NIL
LOCAL _OARQLOG := NIL
...
_CLOG := CHR(13)+CHR(10) + CRLF+I18N("CLIENTES ATUALIZADOS: #1",{_NINC}) + CRLF+I18N("CLIENTES NÃO ATUALIZADOS (ERRO): #1",{_NERR}) + CRLF + CRLF+_CLOG
...
MSExecAuto({|a,b,c| CRMA980(a,b,c)},AREG,3,{}) //MSEXECAUTO({|X,Y|MATA030(X,Y)},AREG,4)
