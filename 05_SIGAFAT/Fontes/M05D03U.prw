...
LOCAL _ODLG := NIL
LOCAL _CTITLE := "ALTERAÇÃO DE PRODUTOS"
LOCAL _OARQORI := NIL
LOCAL _OARQLOG := NIL
...
_CLOG := CHR(13)+CHR(10) + CRLF+I18N("PRODUTOS ALTERADO: #1",{_NINC}) + CRLF+I18N("PRODUTOS NÃO ALTERADOS (ERRO): #1",{_NERR}) + CRLF + CRLF+_CLOG
