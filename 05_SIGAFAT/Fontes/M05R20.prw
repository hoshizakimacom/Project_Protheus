...
oReport := TReport():New("M05R09","Vendas Gerencial","M05R09", {|oReport| ReportPrint(oReport,cAliasQry,oVenProd)},"Este relatorio emite a relacao gerencial de itens do pedido de venda." + "Serão itens do pedido com operação igual a " + " 01|02|03|04|05|06|11|12|28|30|38|39|51|55")
...
TRCell():New(oVenProd,"DESCRI"		,/*Tabela*/	,"Descriçao"		 ,PesqPict("SC6","C6_DESCRI")	,TamSx3("C6_DESCRI")[1]		,/*lPixel*/,{|| cDesc	})				// Descrição do Produto
...
While !oReport:Cancel() .And. !(cAliasQry)->(Eof())
	...
	If !(cAliasQry)->C6_XOPER $ '01|02|03|04|05|06|11|12|28|38|39|51|55'
		(cAliasQry)->(dbSkip())
		Loop
	Endif		
