...
Static Function M05AValid(_cItem) //ADD ITEM COMO PARAMETRO POR CLAUDIO AMBROSINI 
    ...
    If _lRet
        ...
        If ! _lRet
            MsgInfo(I18N('Apontamento não permitido.' + CRLF + CRLF + 'Motivo: Item ' + ' ' +_cItem + ' ' + 'já encontra-se na etapa #1 .',{AllTrim(_cAtuDes)})) //ADD INFORMACOES DE ITEM NA MENSAGEM POR CLAUDIO AMBROSINI
        EndIf
    EndIf
