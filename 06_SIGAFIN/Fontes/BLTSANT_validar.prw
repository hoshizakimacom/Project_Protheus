...
User Function xxBOLSANT(cPrefixo,cNumero,cParcela,cCliente,cLoja,cBanco,cAgencia,cConta)
...
Private nLastKey		:= 0
Private Tamanho		:= "P"
Private cDesc1		:= "Este programa tem como objetivo efetuar a impressใo do"
Private cDesc2		:= "Boleto de Cobran็a com c๓digo de barras, conforme os"
Private cDesc3		:= "parโmetros definidos pelo usuแrio."
Private cString		:= "SE1"
...
//ณ Verifica se a chamada foi feita por outro programa ณ
...
//ณ Atualiza o SX1 se a chamada foi feita por outro programa ณ
...
//ณ Chama a pergunte para definir os parโmetros iniciais ณ
...
cQry	+= " SE1.E1_NUMBCO,SA1.A1_ENDCOB,SA1.A1_CEP,SA1.A1_CEPC,SE1.E1_PEDIDO, SA1.A1_CGC"
...
While !Eof()
 ...
 /*
	If !Empty(RFINR99A->E1_PEDIDO) .and. MV_PAR21 == 1 // Sim
		If SC5->( dbSeek( xFilial("SC5")+RFINR99A->E1_PEDIDO) )
			If SC5->C5_CONDPAG $ cPgtVista
				dbSelectArea("RFINR99A")
				dbSkip()
				Loop
			EndIf
...
*/
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Filtra o tํtulo em rela็ใo ao endere็o de cobran็a ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
/*	If mv_par18 == 1 .And. !( "MESMO" $ RFINR99A->A1_ENDCOB )		// Acompanha NF
		dbSelectArea("RFINR99A")
		dbSkip()
		Loop
	ElseIf mv_par18 == 2 .And. ( "MESMO" $ RFINR99A->A1_ENDCOB )	// Via Correio
		dbSelectArea("RFINR99A")
		dbSkip()
		Loop
	EndIf
...
Static Function xxVisCli( cCliente, cLoja )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษอออออออออออออัออออออออออัออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออปฑฑ
ฑฑบ Programa    ณ MontaRel ณ Monta a imagem do relat๓rio a ser impresso                   บฑฑ
ฑฑบ             ณ          ณ                                                              บฑฑ
ฑฑบ Parโmetros  ณ Nil                                                                     บฑฑ
ฑฑฬอออออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบ Retorno     ณ Nil                                                                     บฑฑ
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Define o tipo de configura็ใo a ser utilizado na MSBAR ณ
//ณ 1 = Polegadas, 2 = Centํmetros                         ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
nTpImp	:= 2          

/*
nTpImp	:= Aviso(	Titulo,;
   		  			"Os boletos devem ser impressos com qual defini็ใo ?",;
					{ "Polegadas", "Centํmetros" },,;
					"Defini็ใo de Tamanho" )
*/
...
*/
		...
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
		//ณ Grava o arquivo com a imagem do boleto se for via correio ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		//If !( aLst[nLoop,15] )
		...
		If Empty(SE1->E1_NUMBCO)
			SE1->E1_NUMBCO	:= aBarra[3]+aBarra[5] //Dema
		Endif
...
ฑฑณFuno    ณ CriaSX1  ณ Autor ณFlavio Macieira        ณ Data ณ24.08.2013 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri็ใo ณ Verifica e cria um novo grupo de perguntas                  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณParametrosณ ExpA1: array com os elementos do SX1                        ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
/*/
Static Function xxCriaSx1(aRegs)
...
ฑฑฬอออออออออออออุออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบ Autor       ณ Flแvio Macieira                                                26.08.13ณบฑฑ
...
ฑฑบ             ณ MC_BCEDEN - Parametro que indica se o Banco serแ o Cedente do Boleto.   บฑฑ
...
ฑฑบ             ณ    Brasil    - 10 Posi็๕es                                              บฑฑ
ฑฑบ             ณ    Bradesco  - 11 Posi็๕es                                              บฑฑ
ฑฑบ             ณ    Santander - 11 Posi็๕es                                              บฑฑ
...
ฑฑบ             ณ          ณ                                                              บฑฑ
ฑฑฬอออออออออออออุออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบ Autor       ณ Flแvio Macieira                                        26.08.13 ณ       บฑฑ
ฑฑฬอออออออออออออุออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xxTCDadBco(aDadEmp, aDadBco)
...
If lRet			 
	...
	EndIf
	/*
	If Alltrim(SEE->EE_CODIGO) == "341"       // Tratamento especifico para Dimep  - Flแvio
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xxTCDadTit(aDadTit, aDadCli, aBarra, aDadBco)
...
If ALLTRIM( SA6->A6_COD + alltrim(SA6->A6_AGENCIA) + SA6->A6_NUMCON ) $ cCedente
	cMensag4    := "Titulo entregue em cessใo fiduciแria em favor do cedente acima."
Endif
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xxTCCalcDV( cBanco, cNNum )
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function xxModulo10(cData)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function xxModulo11(cData)
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function xxMod11237(cData)
...
*/
/*/
Static Function xxModulo11a(cData)  
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xxMod11033(cData) // modulo 11 com base 7 para Santander              
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xxTCImpBol(oPrint,aDadEmp,aDadBco,aDadTit,aDadCli,aBarra,nTpImp)
...
oPrint:Line	(nLin+0130,0500,nLin+0050,0500)															// Quadro
oPrint:Line	(nLin+0130,0710,nLin+0050,0710)												   			// Quadro

//If !Empty(aDadBco[9])
	oPrint:SayBitMap(nLin+0064,0100,cBmp,350,060)													// Logotipo do Banco
//Else
//	oPrint:Say	(nLin+0084,0100,	aDadBco[8],											oFont14)	// Nome do Banco
//EndIf
oPrint:Say	(nLin+0095,0513,	aDadBco[1]+"-"+aDadBco[2],								oFont21)	// N๚mero do Banco + Dํgito

oPrint:Say	(nLin+0104,1900,	"Comprovante de Entrega",								oFont10)	// Texto Fixo
oPrint:Line	(nLin+0130,0100,nLin+0130,2300)															// Quadro
...
oPrint:Line (nLin+0230,0100,nLin+0230,1900 )														// Quadro
oPrint:Line (nLin+0330,0100,nLin+0330,1900 )														// Quadro
oPrint:Line (nLin+0430,1050,nLin+0430,1900 )														// Quadro
oPrint:Line (nLin+0530,0100,nLin+0530,2300 )														// Quadro

oPrint:Line (nLin+0530,1050,nLin+0130,1050 )														// Quadro
oPrint:Line (nLin+0530,1400,nLin+0330,1400 )														// Quadro
oPrint:Line (nLin+0330,1500,nLin+0130,1500 )														// Quadro
oPrint:Line (nLin+0530,1900,nLin+0130,1900 )														// Quadro
...
For nLoop := 100 to 2300 Step 50
	oPrint:Line(nLin+0560, nLoop,nLin+0560, nLoop+30)												// Linha pontilhada
Next nI
...
oPrint:Say  (nLin+0664,1900,	"Recibo do Sacado",									oFont10)	// Texto Fixo
...
oPrint:Say  (nLin+1050,0100,	"Instru็๕es (Todas informa็๕es deste bloqueto sใo de exclusiva responsabilidade do cedente)",;
																						oFont8)		// Texto Fixo
//oPrint:Say  (nLin+1100,0100,	aDadTit[11],											oFont10)	// 1a Linha Instru็ใo
//oPrint:Say  (nLin+1150,0100,	aDadTit[12],											oFont10)	// 2a. Linha Instru็ใo
...
oPrint:Say  (nLin+1605,0100,	"Sacador/Avalista"+ if( !empty(cAvalista)," - " + Rtrim(cAvalista),""),						oFont8)		// Texto Fixo
...
oPrint:Say  (nLin+2855,0100,	"Sacador/Avalista" + if( !empty(cAvalista)," - " + Rtrim(cAvalista),""), oFont8)		// Texto Fixo + Sacador Avalista
...
If nTpImp == 1
	oPrint:FwMSBAR("INT25" ,69,1   ,aBarra[1],oPrint,.F.   ,Nil  ,Nil  ,0.017     ,1   ,Nil    ,Nil,"A"  ,.F. ) //datasupri
Else        
	oPrint:FwMSBAR("INT25" ,69,1   ,aBarra[1],oPrint,.F.   ,Nil  ,Nil  ,0.017     ,1   ,Nil    ,Nil,"A"  ,.F. ) //datasupri
EndIf
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function xxTCCobRem( cBanco, cCampo, nTamanho )
