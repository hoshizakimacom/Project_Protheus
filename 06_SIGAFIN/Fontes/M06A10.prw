...
//----------------------------------------------------------
//ADD OPTION aRotina TITLE 'Visualiza'	ACTION 'U_M06V10()'	 OPERATION 2 ACCESS 0 // 'Visual' - Thiago Marques - 13/08/2025 - Comentado para compatibiliza็ใo 2410
...
//ADD OPTION aRotina TITLE 'Follow-up'	ACTION 'U_M06F10(TRB->FILIAL,TRB->CLIENTE,TRB->LOJA,TRB->PREFIXO,TRB->NUMERO,TRB->PARCELA,TRB->EMISSAO,TRB->VENCTO,TRB->VALOR,TRB->SALDO)'  	 OPERATION 2 ACCESS 0 // 'Consulta Cli' - Thiago Marques - 13/08/2025 - Comentado para compatibiliza็ใo 2410
...
//Efetua a cria็ใo da tabela
oTempTable:Create()
//Cria ํndice com colunas setadas anteriormente
