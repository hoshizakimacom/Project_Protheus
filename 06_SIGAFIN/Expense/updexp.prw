...
aAdd( aSX2, { ;
	'PR2'																	, ; //X2_CHAVE
	cPath																	, ; //X2_PATH
	'PR2'+cEmpr																, ; //X2_ARQUIVO
	'Tabela Temporaria'														, ; //X2_NOME
	''																		, ; //X2_NOMESPA
	''																		, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Id Adiantam.'															, ; //X3_TITULO
	'Id Adiantam.'															, ; //X3_TITSPA
	'Id Adiantam.'															, ; //X3_TITENG
	'Id Adiantamento Expense'												, ; //X3_DESCRIC
	'Id Adiantamento Expense'												, ; //X3_DESCSPA
	'Id Adiantamento Expense'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Id Relatorio'															, ; //X3_TITULO
	'Id Relatorio'															, ; //X3_TITSPA
	'Id Relatorio'															, ; //X3_TITENG
	'Id Relatorio Expense'													, ; //X3_DESCRIC
	'Id Relatorio Expense'													, ; //X3_DESCSPA
	'Id Relatorio Expense'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
