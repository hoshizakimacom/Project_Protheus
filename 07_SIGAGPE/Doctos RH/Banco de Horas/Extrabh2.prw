...
|||          |          |       |                       |      |          |||
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
|||Descrição | Calcular Saldo de Banco de Horas por Período e atualizar   |||  
...
Private STR0002	:="Administração"
Private STR0003	:="Extrato Banco de Horas"
Private STR0004	:="Será impresso de acordo com os parametros solicitados pelo"
...
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
|||          |                                                            |||
|||Descrição | Função para Atualizar Movimento da Folha               	  |||  
|||          | 					                                          |||
|||          | 						                                      |||
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
|||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
AADD(_afields,{"ZF_DTINI","","Período Inicial"})
AADD(_afields,{"ZF_DTFIM","","Período Final"})
