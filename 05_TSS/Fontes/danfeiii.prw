...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//|| RetTamCol -Retorna um array do mesmo tamanho do array de entrada, contendo as||
...
//|| oPrinter   Objeto de impressão instanciado para utilizar o métodonativo de   ||
//||            cálculo de tamanho de texto.									  ||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//|| RetTamTex - Retorna o tamanho em pixels de uma string. (Workaround para o    ||
//|| GetTextWidth)																  ||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//|| nInf, inteiro, Codigo da informação desejada:<br>1 - Normal<br>2 - Cancelametno<br>3 - Inutilização  ||
...
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//|| DANFE_VI					  																		  ||
//|| Funcao utilizada para verificar a ultima versao do fonte DANFEIII.PRW aplicado no rpo do cliente,    ||
//||  assim verificando a necessidade de uma atualizacao neste fonte.									  ||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
//|| Retornar a ultima data do RPO que esta no cliente. Pois o cliente não esta utilizando o DANFEII com  ||
//|| isto esta sendo informado a mensagem que o RdMake não está compilado. 								  ||
//||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||
