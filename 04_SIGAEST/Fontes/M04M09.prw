...
//	MsgStop("M04M09_3")
    ...
    cMailDestino := "sferreira@hoshizakimacom.com.br;wmanzini@hoshizakimacom.com.br" //"marcos.rocha@moovegestao.com.br"
	cAssunto     := "M04M09: Inicio de Processamento - Geracao de Estruturas - ZG1"
	cTexto       := cAssunto
	cAnexos      := ""
	lMensagem    := .F.
	cMensQdoErro := ""
	...
	cAssunto     := "M04M09: Final Processamento - Geracao de Estruturas - ZG1"
	cTexto       := cAssunto
    lReturn      := U_SendMail2(cMailDestino,cAssunto,cTexto,cAnexos,lMensagem,cMensQdoErro)
...
While SG1TRB->(!Eof())  //.And. SG1->G1_FILIAL+SG1->G1_COD <= xFilial('SG1')+mv_par02
	...
	dbSelectArea("SG1TRB")
	While !EOF() .And. SG1TRB->G1_COD == cProduto
		dbSkip()
	EndDo
EndDo
