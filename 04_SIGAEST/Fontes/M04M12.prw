...
User Function M04M12M()
	...
	*/
	...
	Else
		...
		If Aviso("Aviso","JOB já integrado anteriormente !! Lote:"+cLote,{"Fechar","Visualizar LOG"}) = 2
			VerLog(cLote)
		EndIf
...
ZAJ->ZAJ_STATUS := IIF(!EMPTY(cMsgErro),"E","A") //A=APONTADO;E=ERRO
...
cFilSXB := "@B1_XFAMIL2 IN "+FormatIn(RTRIM(GetNewPar("AM_FAMIL2C",.F.,"000011;")),";")
