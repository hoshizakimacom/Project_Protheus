...
ฑฑบPrograma  ณ M04E06  บAutor  ณ Marcos Rocha        บ Data ณ  24/11/23   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Etiqueta Inventแrio                                        บฑฑ
...
Local cTitulo	:= "Etiqueta Inventแrio"
Private aDados := {}
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ M04E06QRY บAutor  ณ Marcos Rocha      บ Data ณ  08/19/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Rotina de Impressใo da Etiqueta                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿*/
...
//Se armazem 03 considera a segunda unidade de medida
cQry := "SELECT B1_COD PRODUTO, B1_DESC DESCRI, B1_CODBAR CODBAR, B1_XCLASIN TIPINV, " +cEOL

cQry += "(CASE WHEN B2_LOCAL = '03' THEN B1_SEGUM ELSE B1_UM END) UM, " +cEOL

cQry += " B2_LOCAL LOCALM , ISNULL(BF_LOCALIZ,'"+SPACE(TAMSX3("BF_LOCALIZ")[1])+"') LOCALIZ " +cEOL

//If mv_par06 == 1
	cQry += " , (SELECT COUNT(*) FROM "+RetSqlName("SBF")+" SBF "+cEOL
	cQry += " 	WHERE BF_FILIAL = '"+xFilial("SBF")+"'"+cEOL
	cQry += " 	AND BF_PRODUTO = B2_COD "+cEOL
	cQry += " 	AND BF_LOCAL = B2_LOCAL "+cEOL
	cQry += " 	AND SBF.D_E_L_E_T_ <> '*' ) QTD_LOCALIZ "+cEOL
//EndIf

cQry += " ,B1_LOCALIZ " +cEOL

cQry += " FROM "+RetSqlName("SB1")+" SB1, "+RetSqlName("SB2")+" SB2 " +cEOL

	//If mv_par06 == 1  // Com Endere็o
	//	cQry += " , "+RetSqlName("SBF")+" SBF "+cEOL
	//EndIf
	cQry += " LEFT OUTER JOIN "+RetSqlName("SBF")+" SBF "+cEOL
	cQry += " ON BF_FILIAL = '"+xFilial("SBF")+"'"+cEOL
	cQry += " AND BF_PRODUTO = B2_COD "+cEOL
	cQry += " AND BF_LOCAL = B2_LOCAL "+cEOL
	cQry += " AND LEFT(BF_LOCALIZ,11) BETWEEN '"+mv_par08+"' AND '"+mv_par09+"' "+cEOL
	cQry += " AND SBF.D_E_L_E_T_ <> '*' "+cEOL

cQry += " WHERE B1_FILIAL = '"+xFilial("SB1")+"'"+cEOL
cQry += " AND B1_COD BETWEEN '"+mv_par01+"' AND '"+mv_par02+"' "+cEOL
cQry += " AND B1_TIPO IN ('BN','EM','ME','MI','MP','PA','PI','PP','MF') "+cEOL
...
//EndIf
If mv_par06 == 1  // Com Endere็o
	cQry += " AND B1_LOCALIZ = 'S' "+cEOL
ElseIf mv_par06 == 2  // Sem Endere็o
	cQry += " AND B1_LOCALIZ = 'N' "+cEOL
EndIf

//TRATAR PARA QUANDO PRODUTO COM CONTROLE DE ENDEREวO E NรO ENCONTRADO ENDEREวO NรO LISTAR
//POR MOTIVO DO FILTRO POR ENDEREวO, SE NภO IRA TRAZER SEMPRE.
cQry += " AND (B1_LOCALIZ = 'N' OR (B1_LOCALIZ = 'S' AND NOT BF_LOCALIZ IS NULL)) "+cEOL

//NรO CONSIDERAR PRODUTOS BLOQUEADOS
cQry += " AND SB1.B1_MSBLQL <> '1' "+cEOL

If !Empty(mv_par10)
	cQry += " AND (SELECT COUNT(*) FROM "+RetSqlName("CB0")+" CB0 "+cEOL
	cQry += " WHERE CB0_FILIAL = '"+xFilial("CB0")+"' "
	cQry += " AND CB0_CODPRO = B2_COD "
	cQry += " AND CB0_LOCAL = B2_LOCAL "
	//If mv_par06 == 1  // Com Endere็o
		cQry += " AND CB0_LOCALI = ISNULL(BF_LOCALIZ,'"+SPACE(TAMSX3("CB0_LOCALI")[1])+"') "
	//EndIf
	cQry += " AND LEFT(CB0_CODETI,7)  BETWEEN '"+mv_par10+"' AND '"+mv_par11+"' "
	cQry += " AND CB0.D_E_L_E_T_ <> '*' ) > 0 "
EndIf

cQry += " ORDER BY LOCALIZ "+cEOL
...
ProcRegua(nTotalReg/*1000*/)

While TRB_SB1->(!Eof())

	IncProc("Carregando Etiquetas a Imprimir : "+TRB_SB1->PRODUTO)
...
//	EndIf
	...
	cEndere := Left(TRB_SB1->LOCALIZ,11)
	nTotLocaliz := TRB_SB1->QTD_LOCALIZ

	If nTotLocaliz > 0		
		nQtdLocaliz	:= 1 
		If nTotLocaliz > 1
			AEVAL(aDados,{|x|nQtdLocaliz:=IIF(x[1]=TRB_SB1->PRODUTO.And.x[5]=TRB_SB1->LOCALM,x[9],0)+1})
		EndIf
	...
	Aadd(aDados,{TRB_SB1->PRODUTO, TRB_SB1->DESCRI, TRB_SB1->UM, TRB_SB1->CODBAR, TRB_SB1->LOCALM,cEndere,cFicha,cAtu_x_Tot,nQtdLocaliz})
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ M04E06BCO บAutor  ณ Marcos Rocha      บ Data ณ  08/19/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Rotina de Impressใo da Etiqueta                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ M04E06IMP บAutor  ณ Marcos Rocha      บ Data ณ  08/19/15   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Rotina de Impressใo da Etiqueta                            บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
Local cDirPadr		:= GetTempPath()	//Diretorio onde serแ salvo o relat๓rio
Local lDisSetup		:= .T.				//Verifica se exibe a tela de setup
Local lViewPDF		:= .T.				//Aviso("Aviso","Deseja visualizar a etiqueta?",{"Sim","Nใo"},,"Aten็ใo:",,"BMPPERG") == 1
...
//ณDefine o local de impressใo padrao caso o Setup esteja desabilitado ณ
...
For nX := 1 to Len(aDados)
	...
	IncProc("Imprimindo Ficha : "+aDados[nX,7])
	...
	For nProc2 := 1 To 2
		...
		//ณ Aplica o fator de conversao para altura e largura padrao do relat๓rio ณ
		...
		// PRIMEIRO BLOCO
		oPrinter:Say(nLinha+20,nCol+90,"Inventแrio "+RIGHT(mv_par07,4),oFont16N)
//		oPrinter:SayBitmap(nLinha+7,nCol+303, "\system\Logo_Macom.bmp", 45,35) //  71,190
		...
		cAtu_x_Tot := If(cAtu_x_Tot=="01/01".Or.EMPTY(cAtu_x_Tot),""," - Multi : "+cAtu_x_Tot)
...
//			nLinha	  := nLinIni
			...
			If nCont == 1   // Nใo Imprime primera contagem
				lImpCont := .F.
...
//			oPrinter:Line(nLinha,nCol,nLinha,nCol+330)
			...
			If 	lImpCont
				...
				oPrinter:Say(nLinha+07,nCol+160,"Crachแ 1:__________ ",oFont14N)
			EndIf
			nLinha	+= (nFator*0.75)
			...
			If 	lImpCont
				...
				oPrinter:Say(nLinha+07,nCol+160,"Crachแ 2:__________ ",oFont14N)
			EndIf

			nLinCodB += 14.0

			If 	lImpCont  //.And. mv_par08 = 1
				cChavebarra := Left(cFicha,2)+SubStr(cFicha,4,4)+cCont+SB1->B1_COD//+RTRIM(cEnderec)
				oPrinter:FWMSBAR("CODE128",nLinCodB,nColCodB,cChavebarra,oPrinter,.F.,,.T.,0.017/*0.040*/,0.6,,,,.F.,)
				//oPrinter:Code128(nLinCodB/*nRow*/ ,nColCodB/*nCol*/, cChavebarra/*cCode*/,0.017/*nWidth*/,0.6/*nHeigth*/,.T./*lSay*/,/*oFont*/,/*nTotalWidth*/)
			EndIf
			//@param nRow Posi็ใo relativa ao topo
			//@param nCol Posi็ใo relativa เ esquerda
			//@param cCodeBar Texto a ser codificado
			//@param nWidth Largura da Barra
			//@param nHeight Altura da Barra
			//@param lSay Indica se deve colocar say com o conte๚do em baixo do c๓digo de barras
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ AvalFicha บAutor  ณ Marcos Rocha      บ Data ณ  08/19/15   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
