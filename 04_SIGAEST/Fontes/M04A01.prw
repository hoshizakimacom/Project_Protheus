...
//+------------------------------------------------------------------------------------------------
//| Cadastro de Valores de Rateio de Chapas por mês
...
Static Function MenuDef()
	...
	AAdd(aRotina,{"Visualizar" , "VIEWDEF.M04A01"    , 0,2} )
	AAdd(aRotina,{"Incluir" , "VIEWDEF.M04A01"    , 0,3 } )
	AAdd(aRotina,{"Alterar" , "VIEWDEF.M04A01"    , 0,4 } )
	AAdd(aRotina,{"Excluir" , "VIEWDEF.M04A01"    , 0,5 } )
