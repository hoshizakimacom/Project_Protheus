...
oReport := TReport():New("M10R06","ITENS FATURADOS X QUALIDADE","M10R06", {|oReport| ReportPrint(oReport,cAliasQry,oVenProd)},"Este relatorio emite a relaçao de itens dos pedidos " + " " + "de venda para acompanhamento da qualidade.")
...
//³                                                                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oVenProd := TRSection():New(oReport,"ITENS FATURADOS X QUALIDADE",{"SC5","SC6"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)		// "Relacao de Pedidos por Produto"
...
TRCell():New(oVenProd,"EMISSAO"		,/*Tabebla*/,"Emissão"			 ,PesqPict("SC5","C5_EMISSAO")	,TamSx3("C5_EMISSAO")[1]+2	,/*lPixel*/,{|| dDatEmis})		// Data de emissão
