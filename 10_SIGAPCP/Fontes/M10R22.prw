...
±±³Programa  ³ M10R22   ³ Autor ³ Wallace Manzini     ³ Data ³ 05/05/2026 ³±±
...
oReport := TReport():New("M10R22","Diario Engenharia","M10R22", {|oReport| ReportPrint(oReport,cAliasQry,oVenProd)},"Este relatorio emite a relacao diaria de itens do pedido de venda" + " " + " para pedidos de venda com status Ativos.")
...
TRCell():New(oVenProd,"DESC.CIENT."	,/*Tabela*/	,"Descr.Cientifica"	 ,PesqPict("SB5","B5_CEME")		,TamSx3("B5_CEME")[1]		,/*lPixel*/,{||	cCeme})					// Descr. Cientifica
//	nPvLib   := 0
//  nSldLib  := 0
//	nSldDisp := 0
...
While !oReport:Cancel() .And. !(cAliasQry)->(Eof())
	...
	*/
	...
	If Empty(cClasse)
		cClasse		:= U_ClassRet((cAliasQry)->TOT_SC6)
	Endif
...
*/
	cCeme 		:= Posicione("SB5",1,xFilial("SB5")+SC6->C6_PRODUTO,"B5_CEME")
...
±±³Programa  ³ ClassRet ³ Autor ³ Cleber Maldonado      ³ Data ³ 30/06/17 ³±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß*/
User Function ClassRet(nTotPed)
