...
Static Function M10E05P(_cCodProd,_nQtd,_cNumSer)
    ...
    Local _cItemOp      := SC2->C2_ITEM                 //#7683
    Local _cSeqItem     := SC2->C2_SEQUEN               //#7683
    Local _cItemGri     := SC2->C2_ITEMGRD              //#7683
    ...
    _oPrinter:Say(_nRow + 430 , 250,                    AllTrim(_cNumOP)+ AllTrim(_cItemOp)+AllTrim(_cSeqItem)+AllTrim(_cItemGri) ,_OFontGM)	//Numero de Série
    _oPrinter:FWMSBAR('CODE128',13 /*nRow*/,1.6/*nCol*/,AllTrim(_cNumOP)+ AllTrim(_cItemOp)+AllTrim(_cSeqItem)+AllTrim(_cItemGri) ,_oPrinter,.F./*lCheck*/,/*Color*/,/*lHorz*/, 0.018/* nWidth*/,0.5/* 1.5 nHeigth*/,/*lBanner*/,/*cFont*/,/*cMode*/,.F.,/*0.5*/,/*0.5*/,/*lCmtr2Pix*/) //Cod. Barra Número Série
