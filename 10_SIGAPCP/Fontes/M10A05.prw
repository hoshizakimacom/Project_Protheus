...
If PARAMIXB3==4
    ...
    If lOk
        ...
        ConOut("Inicio: "+Time())
        MSExecAuto({|x,y,z| PCPA200(x,y,z)},PARAMIXB1,PARAMIXB2,PARAMIXB3) //MSExecAuto({|x,y,z| mata200(x,y,z)},PARAMIXB1,PARAMIXB2,PARAMIXB3)
        //Inclusao
        ConOut("Fim: "+Time())
    EndIf
Else
    ...
    If lOk
        ...
        ConOut("Inicio: "+Time())
        MSExecAuto({|x,y,z| PCPA200(x,y,z)},PARAMIXB1,NIL,5) //MSExecAuto({|x,y,z| mata200(x,y,z)},PARAMIXB1,NIL,5)
        //Exclusao
        lOk := !lMsErroAuto
        ConOut("Fim: "+Time())
    EndIf
