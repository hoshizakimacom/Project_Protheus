...
oReport := TReport():New("M10R15","DIAS EM ESTOQUE" + Alltrim(DTOC(ddatabase)) ,"M10R15", {|oReport| ReportPrint(oReport,cAliasQry,oVenProd)},"Este relatorio emite a relacao de dias em estoque por produto," + " " + " de acordo com seu numero de série.")
...
//³                                                                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oVenProd := TRSection():New(oReport,"DIAS EM ESTOQUE",{"SCK","SB1"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)		// "Relacao de Pedidos por Produto"
...
TRCell():New(oVenProd,"DESCRICAO"	,/*Tabela*/ ,"Descricao"		,PesqPict("SB1","B1_DESC")		,TamSx3("B1_DESC")[1]		,/*lPixel*/,{|| _cDesc	 })	// Descrição do produto
TRCell():New(oVenProd,"FAMILIA"		,/*Tabela*/ ,"Familia"			,PesqPict("SB1","B1_CODITE")	,TamSx3("B1_CODITE")[1]		,/*lPixel*/,{|| _cDescFam})	// Familia de produto
TRCell():New(oVenProd,"NUMSER"		,/*Tabela*/ ,"Numero de Serie"	,PesqPict("ZAB","ZAB_NUMSER")	,TamSx3("ZAB_NUMSER")[1]	,/*lPixel*/,{|| _cNumSer })	// Numero de Série do Produto
...
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
dbSelectArea("ZAB")		// Itens do Orçamento
