...
±±³Descri‡…o ³ Relacao de Numeros de Série dos Itens do Pedido de Vendas  ³±±
...
oReport := TReport():New("M10R07","Numeros de Série dos Itens do Pedido","M10R07", {|oReport| ReportPrint(oReport,cAliasQry,oVenProd)},"Este relatorio emite a relaçao de numeros de série " + " " + "dos itens do pedido de vendas.")
...
//³                                                                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
oVenProd := TRSection():New(oReport,"NUMEROS DE SÉRIE X PEDIDO",{"ZA0","SC1"},/*{Array com as ordens do relatório}*/,/*Campos do SX3*/,/*Campos do SIX*/)		// "Relacao de numeros de série"
...
TRCell():New(oVenProd,"DESCRICAO"	,/*Tabela*/ ,"Descrição Produto" ,PesqPict("SB1","B1_DESC")		,TamSx3("B1_DESC")[1]		,/*lPixel*/,{|| cDesc	})		// Numero de série
TRCell():New(oVenProd,"NUM SERIE"	,/*Tabela*/ ,"Num.Série"		 ,PesqPict("ZAB","ZAB_NUMSER")	,TamSx3("ZAB_NUMSER")[1]	,/*lPixel*/,{|| cNumSer	})		// Numero de série
...
TRCell():New(oVenProd,"ITEM PEDIDO"	,/*Tabela*/	,"Item Pedido"		 ,PesqPict("ZAB","ZAB_ITEMPV")	,TamSx3("ZAB_ITEMPV")[1]	,/*lPixel*/,{|| cItem 	})		// Código do Produto
TRCell():New(oVenProd,"EMISSAO PED"	,/*Tabela*/ ,"Emissão Pedido"	 ,PesqPict("SC5","C5_EMISSAO")	,TamSx3("C5_EMISSAO")[1]	,/*lPixel*/,{|| dData	})		// Data
TRCell():New(oVenProd,"NUM OP"		,/*Tabela*/ ,"Num.OP"			 ,PesqPict("ZAB","ZAB_NUMOP")	,TamSx3("ZAB_NUMOP")[1]		,/*lPixel*/,{|| cOP		})		// Numero de série
